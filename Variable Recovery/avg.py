...
def plot_true_beta_gamma(beta, gamma, S, I, R, S_cum, I_cum, R_cum, train):
    ...
    plt.plot(-beta*S_cum*I_cum, label='dS using mean beta')
    ...
    plt.plot(beta*S_cum*I_cum - gamma*I_cum, label='dI using mean beta and gamma')
    ...
    plt.plot(gamma*I_cum, label='dR using mean gamma')
